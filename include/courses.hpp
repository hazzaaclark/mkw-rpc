...
std::map<std::string, const char*> COURSES =
{
	/** NITRO COURSES **/
	...
	{ "TOAD'S FACTORY", "factory_course.szs" },
	...
	{ "BOWSER CASTLE", "koopa_course.szs" },
	...
	{ "SNES GHOST VALLEY 2", "old_obake_sfc.szs" },
	...
	{ "GBA BOWSER CASTLE 3", "old_koopa_gba.szs" },
